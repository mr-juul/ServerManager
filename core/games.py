...
CATALOG: tuple[GameDefinition, ...] = (
    ...
    GameDefinition("minecraft-java", "Minecraft Java", "Java server instance.", "⛏", requires_java=True, server_search_names=("server.jar",), has_world=True, supported=True, detection_capability="FULL", installation_capability="MANUAL", configuration_capability="PARTIAL", web_create_supported=True, web_edit_supported=True),
    GameDefinition("terraria", "Terraria", "Terraria dedicated server.", "🧱", 105600, server_search_names=("TerrariaServer.exe",), has_world=True, supported=True, detection_capability="FULL", installation_capability="MANUAL", configuration_capability="PARTIAL", web_create_supported=True, web_edit_supported=True),
